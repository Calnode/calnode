	...
	<div class="max-w-md rounded-lg border bg-card p-6">
		...
		{#if status?.configured === false}
			<div class="rounded-md bg-amber-50 px-3 py-2.5 text-sm text-amber-800 ring-1 ring-inset ring-amber-200">
				...
				<p class="mt-1 text-amber-700">Add your Google OAuth credentials in <a href="/admin/settings#google-oauth" class="underline font-medium">Settings → Google OAuth</a>, then restart the server.</p>
			</div>
